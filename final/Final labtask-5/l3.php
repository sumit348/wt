...
<body>
    ...
    <main id="main">
        ...
        <section id="section-a" class="grid">
            <div class="content-wrap">
                <h2 class="content-title">About Doctors Lab</h2>
            ...
            <ul>
                <li>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title">Primary Care</h3>
                ...
                <li>
                    <div class="card">
                        <img src="2.jpg" alt="">
                        <div class="card-content">
                            <h3 class="card-title">Online Appointment</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum culpa neque quo eum et
                                quasi velit voluptatum cum maiores exercitationem.</p>
                        </div>
                    </div>
        ...
        <section id="section-c" class="grid">
            <div class="content-wrap">
                <h2 class="content-title">We Handle Your Health Support</h2>
        ...
        <section id="section-d" class="grid">
            <div class="box">
                ...
                <p>contact@sumit.mh07@gmail.com</p>
            </div>
            <div class="box">
                <h2 class="content-title">About Our Policy</h2>
    ...
    <footer id="main-footer" class="grid">
        <div>Doctors Lab</div>
        <div>Project By <a href="#" target="_blank">Mehedi Hasan</a></div>
    </footer>
