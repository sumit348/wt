...
<html>
	...
	<body>
		...
		<div class="dregister">
			<div class="para1">
				<p class="p1">
					Welcome to Digital Hospital ! By signing up 
					with digitalhospital.com, you confirm your understanding and agreement 
					that each appointment brought to you by digitalhospital.com will have a nominal fee of <mark>BDT 200</mark>
				</p>
			</div>
